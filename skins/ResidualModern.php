 ...
 * @ingroup Skins
 */
class SkinResidualModern extends SkinTemplate {
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'residualmodern';
		$this->stylename = 'residualmodern';
		$this->template  = 'ResidualModernTemplate';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'residualmodern/menu.css', 'screen' );
		$out->addStyle( 'residualmodern/layout.css', 'screen' );
		$out->addStyle( 'residualmodern/chart.css', 'screen' );
		/*if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}*/

		//$out->addStyle( 'residualmodern/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
		//$out->addStyle( 'residualmodern/IE55Fixes.css', 'screen', 'IE 5.5000' );
		$out->addStyle( 'residualmodern/ie6.css', 'screen', 'IE 6' );
		$out->addStyle( 'residualmodern/ie7.css', 'screen', 'IE 7' );
		$out->addStyle( 'residualmodern/print.css', 'print' );
	}
}
 ...
 * @ingroup Skins
 */
class ResidualModernTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for ResidualVM skin.
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" id="tableMain">
  <tr id="topHeader"> 
    <td width="199px"><a href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>"<?php
			echo $skin->tooltipAndAccesskeyAttribs('p-logo') ?>><img src="<?php $this->text('stylepath') ?>/<?php $this->text('stylename') ?>/logo.png" width="199" height="65" alt="ResidualVM logo" /></a></td>
    ...
    <td width="50%" style="background-image: url('<?php $this->text('stylepath') ?>/<?php $this->text('stylename') ?>/top_bg.png'); vertical-align: middle; text-align: left; white-space:nowrap;">
      <a href="http://www.residualvm.org/" target="_parent" class="toplinks" style="color: #32792D;" id="tl_mw">Main website</a> - 
      <a href="http://forums.residualvm.org/" target="_parent" class="toplinks" style="color: #32792D;" id="tl_f">Forums</a> -
      <a href="http://buildbot.residualvm.org" target="_parent" class="toplinks" style="color: #32792D;" id="tl_b">BuildBot</a> -
      <a href="http://doxygen.residualvm.org" target="_parent" class="toplinks" style="color: #32792D;" id="tl_d">Doxygen</a> -
      <a href="http://www.residualvm.org/contact.php" target="_parent" class="toplinks" style="color: #32792D;" id="tl_cu">Contact us</a>
	  </td>
  ...
  <tr id="tableColor" bgcolor="#D5ECDD"> 
    <td colspan="4">
	          ...
	          <div id="container"> 
  	          ...
  	          <div id="p-cactions" class="portlet">
  		        ...
  		        <div class="rbtop"> <!-- start of title -->
			         <div>
				        <p><span class="shadow-container" style="color: #FFF;"><?php $this->data['displaytitle']!=""?$this->html('title'):$this->text('title') ?><span class="shadow-text" style="color: #32792D;"><?php $this->data['displaytitle']!=""?$this->html('title'):$this->text('title') ?></span></span><br /></p>
               </div>
              </div> <!-- end of title -->
		          <div class="rbcontent">
			         <div class="rbwrapper">
    ...
    <td colspan="4">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableFooter">
        <tr>
          ...
          <td width="100%" bgcolor="#D5ECDD">&nbsp;</td>
...
<?php		}
		...
		wfRunHooks( 'ResidualVMTemplateToolboxEnd', array( &$this ) );
